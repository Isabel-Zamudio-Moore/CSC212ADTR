...
public class JavaMapTest {
	...
	/**
	 *  Allow us to test that an integer
	 *  is equal with another integer
	 */
	// you might want this.
	...
	/**
	 *  Test that empty map is empty
	 *  The test should have no errors or failures
	 *  if the empty map is empty
	 */
	@Test
	...
	/**
	 *  Test that put method is working
	 *  The test should have no errors or failures
	 *  if the put method is putting items into map
	 */
	@Test
	public void testPut() {
	...
	/**
	 *  Test that get method is working
	 *  The test should have no errors or failures
	 *  if the get method is telling us the
	 *  corresponding value to the key we want
	 */
	 ...
	 *  The test should have no errors or failures
	 *  if the remove method is removing the item we 
	 *  ask to remove
	 */
	@Test
