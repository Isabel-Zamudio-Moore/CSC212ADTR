...
public class JavaChallengesTest {
	...
	/**
	 * Test that the intersection method functions as
	 * has been expected
	 * for empty lists
	 */
		@Test
		...
		/**
		 * Test that the intersection method works to join sets
		 * for single and larger lists
		 */
		@Test
		...
		/**
		 * Test that the union method functions as
		 * has been expected
		 * for empty lists
		 */
		@Test
		...
		/**
		 * Test that the union method works to join sets
		 * for single and larger lists
		 */
		@Test
		...
		/**
		 * Test that the word count method functions as
		 * has been expected
		 * for empty lists
		 */
		@Test
		...
		/**
		 * Test that the word count method works for a list
		 * for single and larger lists
		 */
		@Test
