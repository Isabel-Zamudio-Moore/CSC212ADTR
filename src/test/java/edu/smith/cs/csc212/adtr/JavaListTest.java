// Citations- Help from TAs, Lab Partner: Talia
...
public class JavaListTest {
	...
	/**
	 *  Test that AddToBackEmpty adds items to the back of an 
	 *  Empty List
	 */
	@Test
	...
	/**
	 *  Test that AddToBack adds items to back of list for single
	 *  and larger sized lists
	 */
	...
	/**
	 * Test the add Index List will actually add an item at the given
	...
	/**
	 * Test if add index works to add an item at a given index
	 *  for single and longer lists
	 */
	@Test
